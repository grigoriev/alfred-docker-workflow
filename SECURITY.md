...
https://github.com/grigoriev/alfred-docker-workflow/security/advisories/new
...
Vulnerabilities in upstream software (Alfred, the Docker CLI, iTerm2, `jq`) belong to the upstream project. Tell us as well
